  ...
  return (
    <header className="bg-[#390194]">
      ...
      >
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">TravelFriend</span>
            {/* <img
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#390194] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
